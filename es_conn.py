...
class ESConnection:
    ...
    def conn(self):
        for _ in range(10):
            try:
                ...
                print("Fail to connect to es: " + str(e))
                time.sleep(1)
                ...
                try:
                    if not self.version():
                        ...
                        r = self.es.update(
                            ...
                            refresh=True,
                            retry_on_conflict=100)
                    print("Successfully upsert: %s" % id)
                    T = True
                    break
                except Exception as e:
                    print("Fail to index: " +
    ...
    def bulk(self, df, idx_nm=None):
        ...
        for d in df:
            ...
            if "_id" in d:
                del d["_id"]
            acts.append(
                {"update": {"_id": id}, "retry_on_conflict": 100})
    ...
    def rm(self, d):
        for _ in range(10):
            try:
                ...
                print("Fail to delete: " + str(d) + str(e))
                if re.search(r"(Timeout|time out)", str(e), re.IGNORECASE):
                    time.sleep(3)
                    continue
        ...
        for i in range(3):
            try:
                ...
                if str(e).find("Timeout") > 0:
                    continue
                raise e
        print("ES search timeout for 3 times!")
    ...
    def updateByQuery(self, q, d):
        ...
        for i in range(3):
            try:
                ...
                print("ES updateByQuery exception: " +
    ...
    def deleteByQuery(self, query, idxnm=""):
        for i in range(3):
            try:
                ...
                print("ES updateByQuery deleteByQuery: " +
    ...
    def indexExist(self, idxnm):
        ...
        for i in range(3):
            try:
                ...
                print("ES updateByQuery indexExist: " + str(e))
                if str(e).find("Timeout") > 0 or str(e).find("Conflict") > 0:
                    continue
    ...
    def createIdx(self, idxnm, mapping):
        try:
            ...
            print("ES create index error %s ----%s" % (idxnm, str(e)))

    def deleteIdx(self, idxnm):
        try:
            return self.es.indices.delete(idxnm, allow_no_indices=True)
        except Exception as e:
            print("ES delete index error %s ----%s" % (idxnm, str(e)))
    ...
    def scrollIter(self, pagesize=100, scroll_time='2m', q={
        ...
        for _ in range(100):
            try:
                ...
                print("ES scrolling fail. " + str(e))
                time.sleep(3)

        sid = page['_scroll_id']
        scroll_size = page['hits']['total']["value"]
        print("[TOTAL]%d" % scroll_size)
        # Start scrolling
        while scroll_size > 0:
